Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/zumo/zumokit-ios.git', :branch => 'release/1.0.3' }
  s.ios.deployment_target = '10.0'
  s.source_files = [
    'ZumoKit/Classes/**/*',
    'ZumoKit/Classes/Bridge/ObjC/**/*',
    'ZumoKit/Classes/Bridge/ObjCPP/**/*',
    'ZumoKit/Classes/Bridge/SupportLib/**/*',
    'ZumoKit/NativeLibs/universal/include/**/*'
  ]
  s.preserve_paths = "ZumoKit/NativeLibs/universal/include/**/*"
  s.public_header_files = ['ZumoKit/Classes/Public/*.h','ZumoKit/Classes/Bridge/ObjC/**/*.h']
